...
- [ ] 2.0 Define agent coordination and assignment instructions
  - [ ] 2.1 Write clear instructions for reading and understanding `claude-swarm.yml` agent configurations
  - [ ] 2.2 Create guidelines for matching task descriptions to agent specializations using keyword analysis
  - [ ] 2.3 Define protocols for automatic agent activation based on task list requirements
  - [ ] 2.4 Establish rules for sub-task delegation to appropriate specialized agents
  - [ ] 2.5 Include instructions for handling agent escalation when tasks are outside their expertise
